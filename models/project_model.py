...
class ProjectModel(QObject):
    ...
    def reset(self):
        ...
        self.settings = {
            "interviewers_per_supervisor": 8,   # Default value
    ...
    def update_general(self, field, value):
        ...
        if field == "sample_types":
            ...
            if "Boosters" not in self.general[field]:
    ...
    def _calculate_supervisor_coefficient(self, province, audience, element_cost_name, sample_sizes):
        ...
        if project_type == "CLT" or project_type == "HUT":
            ...
            # (Sample size (Main, Booster)/ Số lượng PVV/(Target/PVV))+2
                ...
                # Calculate total daily SUP target Main + Boosters
                coefficient = 0
                formula_parts = ["Target ngày của SUP (Main + Boosters) + 2:"]

                for sample_type in ["Main", "Boosters", "Extra for Main", "Extra for Boosters"]:
